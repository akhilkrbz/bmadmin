                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Create New Bed</li>
                        </ol>
                    </div>
                </div>
                <!--end::Row-->
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="card card-warning card-outline mb-4">
                            ...
                            <div class="card-header">
                                <div class="card-title">Create New Bed</div>
                            </div>
                            <!--end::Header-->
                            <!--begin::Form-->
                            <form action="{{ route('beds.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="date_of_bed" required class="form-control datepicker" value="{{ date('d-m-Y') }}" id="date_of_bed" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="inputPassword3" class="col-sm-2 col-form-label">No. of beds</label>
                                        <div class="col-sm-10">
                                            <input type="number" name="no_of_beds" required class="form-control" id="no_of_beds" value="8"/>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
