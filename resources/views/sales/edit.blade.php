                                ...
                                <div class="card-body">
                                    ...
                                    <div id="items-container">
                                        ...
                                        <div class="row mb-2 item-row">
                                            ...
                                            <div class="col">
                                            <input type="number" step="0.01" name="items[{{ $i }}][amount]" class="form-control amount-input" value="{{ $item->amount }}" required>
                                            </div>
                                            <div class="col-auto">
                                    ...
                                    <div class="row mb-3 justify-content-end">
                                        <div class="col-sm-3">
                                            ...
                                            <input type="number" step="0.01" name="total_amount" id="total_amount" class="form-control" value="{{ old('total_amount', $sale->total_amount) }}" required readonly>
                                        </div>
                                        <div class="col-sm-4">
